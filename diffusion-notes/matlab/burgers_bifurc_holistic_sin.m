function [nums,amps,lams]=burgers_bifurc_holistic_sin(period,amp_start,amp_end,amp_step)
%----------------------------------------------------------------
% GAJ 05/01/2015
% Checks bifurcation stability of
% Burgers' eq. with unit viscosity, u_t=u_xx-uu_x.
% Uses holistic finite difference approximations for u_x and u_xx.
...
for A=amp_start:amp_step:amp_end
  [~,lam]=calc_eigs(A*u0_sin(), @burgers_dudt_holistic);
