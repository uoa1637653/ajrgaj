...
$\theta=\frac{2}{3}$ (mixture). Instability (detected when $|U_j|>1000$) is denoted by 'x', and irregularity
(the presence of non-monotonic modes) ia denoted by '+'.}
\label{fig:numeric1}
\end{figure}
...
and thus proprtional to the grid-spacing $H$. Neither the conservative, mixture nor holistic models
inherently outperform the others.
