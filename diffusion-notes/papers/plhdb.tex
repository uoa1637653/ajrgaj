...
\author{G.~A. Jarrad\thanks{Data Modelling Institute, University of Adelaide, South Australia~5005, Australia.  
\protect\url{mailto:geoff.jarrad@adelaide.edu.au}}
\and 
...
has been shown to have the special property that it 
preserves the self-adjointness of the diffusion operator $\cL$ under conventional periodic, Dirichlet or Neumann boundary conditions. Also of interest is the fact, noted in Section~\ref{sec:nonlin}, that
...
as discussed in Section~\ref{sec:nonlin}. ** geometric integrator?
It would be interesting to compare the stability of the fully second-order holistic approximation against the mixture model with correspondingly higher-order 
