...
$U_0=U_3=0$. The mixture model~\eqref{eq:mixture} then reduces to
\begin{eqnarray}
\dot{U}_1 & = & \frac{\nu}{H^2}(-2U_1+U_2)-\frac{\alpha(1-\theta)}{2H}U_1U_2-\frac{\alpha\theta}{4H}U_2^2\,,
\\
\dot{U}_2 & = & \frac{\nu}{H^2}(U_1-2U_2)+\frac{\alpha(1-\theta)}{2H}U_1U_2+\frac{\alpha\theta}{4H}U_1^2\,.
\end{eqnarray}
A stable critical point occur at $U_1=U_2=0$ with non-dimensionalised eigenvalues 
$\bar{\lambda}=\lambda H^2/\nu=-1, -3$.
An unstable critical point occurs at $U_1=-U_2=\frac{12\nu}{\alpha H(2-3\theta)}$
with eigenvalues $\bar{\lambda}=\frac{2}{2-3\theta}
\pm\frac{|4-9\theta|}{|2-3\theta|}$. Observe that the unstable point is removed to infinity when $\theta=\frac{2}{3}$.
...
\begin{eqnarray}
\dot{U}_1 & = & \frac{\nu}{4H^2}(-16U_1+11U_2)-\frac{\alpha}{24H}(2U_1^2+9U_1U_2+7U_2^2)\,,
\\
\dot{U}_2 & = & \frac{\nu}{4H^2}(11U_1-16U_2)+\frac{\alpha}{24H}(7U_1^2+9U_1U_2+2U_2^2)\,,
\end{eqnarray}
has only a stable critical point at $U_1=U_2=0$ with eigenvalues $\bar{\lambda}= -\frac{5}{4}, -\frac{27}{4}$.
