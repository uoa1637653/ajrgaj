...
\paragraph{Connection with differentiation}
We note from the relevant Taylor series exapnsion that
$\frac{\mu\delta}{H}u=u_x+\Ord{H^2}$,
$\left(1-\frac{1}{6}\delta^2\right)\frac{\mu\delta}{H}u=u_x+\Ord{H^4}$ and
$\left(1-\frac{1}{6}\delta^2+\frac{1}{30}\delta^4\right)\frac{\mu\delta}{H}u=u_x+\Ord{H^6}$;
consequently, $S\frac{\mu\delta}{H}=\frac{\partial}{\partial x}+\Ord{H^4}$,
since $S=\left(1+\frac{1}{6}\delta^2\right)^{-1}\sim 1-\frac{1}{6}\delta^2+\frac{1}{36}\delta^4-\cdots$.
Similarly, observe that
$\frac{\delta^2}{H^2}u=u_{xx}+\Ord{H^2}$,
$\left(1-\frac{1}{12}\delta^2\right)\frac{\delta^2}{H^2}u=u_{xx}+\Ord{H^4}$
and
$\left(1-\frac{1}{12}\delta^2+\frac{1}{90}\delta^4\right)\frac{\delta^2}{H^2}u=u_{xx}+\Ord{H^6}$;
hence, $S^{\frac{1}{2}}\frac{\delta^2}{H^2}=\frac{\partial^2}{\partial x^2}+\Ord{H^4}$,
...
\begin{eqnarray}
  \hat{v}_0 = \chi_j(x)\xi_j + \chi_{j+1}(x)(1-\xi_j),
\end{eqnarray}
which satisfies both the continuity condition~\eqref{eq:ccc} and the smoothness condition~\eqref{eq:ccj}
(for $\gamma=0$). 
Now, recalling that $u^n(X_j,\vec{U})=0$ for $n\ge 1$,
and hence $[\nu u^n_x]_j=0$ for $n\ge 2$, 
taking the inner product of equation~\eqref{eq:order-n} with~$\hat{v}_0$ gives rise to the solvability condition
\begin{eqnarray}
 HS^{-1}g^n_{j}
-\left< {\cR}\big({u}^{\langle n-1\rangle},\gv^{\langle n-1\rangle}\big), \hat{v}_0 \right>
=0 \mbox{ for } n=2,3,\ldots\,.
\end{eqnarray}
