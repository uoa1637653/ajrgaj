...
Substituting the linear approximation $u=u_0+{\cal O}(\gamma+C)$, from equation~\eqref{eq:uhat0}, and simplifying then leads to
\begin{eqnarray}
	\dot{U}_j & = & 
S\gamma\frac{\delta^2U_j}{H^2} - SC\frac{\mu\delta U_j}{H} + {\cal O}((\gamma+C)^2)\,,
\end{eqnarray}
