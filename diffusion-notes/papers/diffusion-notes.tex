...
In order to see that the $C^2$ term is an artifact of the expansion of $\hat{g}_j$, 
higher order terms in $\gamma$ are first found, and then $S$ is replaced by its asymptotic expansion
\begin{eqnarray}
...
\end{eqnarray}
and then consider the partial sums $\sum_{p=0}^{n}\gamma^p\kappa^q$ of terms in the real part of the
subsequent expansion for $\dot{\tilde{u}}$. The relevant coefficients are listed in Table~\ref{tab:partial:kappa}.
...
\end{eqnarray}
 The relevant coefficients are listed in Table~\ref{tab:partial:kappa:pi}.

\begin{table}[hbtp]
\centering
\begin{tabular}{|c|c|c|c|c|c|c|}
\hline
$n\backslash q$ & 2 & 4 & 6 & 8 & 10 & 12\\
\hline
&&&&&&\\[-2ex]
0 & 0 & $-\frac{\bar{C}^2}{720}$ & $-\frac{\bar{C}^2}{1440}$ & $-\frac{23\bar{C}^2}{172800}$        
   & $-\frac{97\bar{C}^2}{7257600}$            & $-\frac{137\bar{C}^2}{435456000}$
\\[1ex]
1 & -1 & $\frac{\bar{C}^2-60}{720}$ & $\frac{25\bar{C}^2-84}{30240}$
   & $\frac{45\bar{C}^2+68}{241920}$  & $\frac{61\bar{C}^2+396}{7257600}$
   & $\frac{-494857\bar{C}^2+458180}{100590336000}$
\\[1ex]
2 & -1 & 0 & $\frac{-\bar{C}^2+42}{7560}$ & $\frac{-17\bar{C}^2-20}{302400}$
   & $\frac{19\bar{C}^2-210}{1814400}$ & $\frac{256597\bar{C}^2-354480}{25147584000}$
\\[1ex]
3 & -1 & 0 & 0 & $\frac{\bar{C}^2-80}{302400}$ & $\frac{-185\bar{C}^2+1716}{29937600}$
   & $\frac{-160931\bar{C}^2+421680}{25147584000}$
\\[1ex]
4 & -1 & 0 & 0 & 0 & $\frac{5\bar{C}^2+33}{7484400}$ 
   & $\frac{3571\bar{C}^2-18330}{2335132800}$
\\[1ex]
5 & -1 & 0 & 0 & 0 & 0  & $\frac{-541\bar{C}^2+3640}{5448643200}$
\\[1ex]
6 & -1 & 0 & 0 & 0 & 0 & 0\\[1ex]
\hline
\end{tabular}
\caption{The coefficients of the partial sums $\sum_{p=0}^{n}\gamma^p\kappa^q$ in the 
asymptotic expansion of $\Re\bar{\lambda}$ about $\kappa=0$ for leading values of $n$ and $q$.}
...
\hline
&&&&\\[-2ex]
0 & -\bar{C}^2 & \frac{21\bar{C}^2}{10} & -\frac{43\bar{C}^2}{16}
 & \frac{6599\bar{C}^2}{2400} 
 %& -\frac{9517\bar{C}^2}{3840} & \frac{24915959\bar{C}^2}{12096000}
 %& -\frac{103353911\bar{C}^2}{63866880}
\\[1ex]
1 & -\frac{11\bar{C}^2+60}{5} 
  & \frac{3693\bar{C}^2+3150}{350}
  & -\frac{68651\bar{C}^2+14700}{2800}
  & \frac{3363527\bar{C}^2+254100}{84000}
%  & -\frac{8204700+249114731\bar{C}^2+}{4704000}
%  & \frac{28963}{28800}+\frac{25766963567}{423360000}\bar{C}^2
%  & -\frac{15430207}{26611200}-\frac{3536439836411}{55883520000}\bar{C}^2
\\[1ex]
2  & -\frac{1680+604\bar{C}^2}{175}
 & \frac{2205+5238\bar{C}^2}{175}
 & -\frac{5880+38457\bar{C}^2}{350}
 & \frac{135170+1835907\bar{C}^2}{7000}
\\[1ex]
3 & -\frac{1728+820\bar{C}^2}{175}
 & \frac{1195425+4365684\bar{C}^2}{67375}
 & -\frac{5266800+46516941\bar{C}^2}{134750}
 & \frac{23827650+381546717\bar{C}^2}{336875}
\\[1ex]
4 & -\frac{665280+398752\bar{C}^2}{67375}
  & \frac{14189175+74897568\bar{C}^2}{625625}
  & -\frac{46718100+546237738\bar{C}^2}{625625}
  & \frac{606434400+11781610899\bar{C}^2}{3128125}
\\[1ex]
5 & -\frac{216103680+156609952\bar{C}^2}{21896875}
 & \frac{3022662825+21815533008\bar{C}^2}{109484375}
 & -\frac{554731632+8348803326\bar{C}^2}{4379375}
 & \frac{243110649600+5723868640599\bar{C}^2}{547421875}
\\[1ex]
6 & -\frac{1080552960+918126656\bar{C}^2}{109484375}
  & \frac{?+?\bar{C}^2}{846015625}
  & -\frac{?+?\bar{C}^2}{9306171876}
  & \frac{?+?\bar{C}^2}{6647265625}
\\[1ex]
\hline
\end{array}
\]
\caption{The coefficients of the partial sums $\sum_{p=0}^{n}\gamma^p\grave{\kappa}^q$ in the 
asymptotic expansion of $\Re\bar{\lambda}$ about $\grave{\kappa}=0$ (or $\kappa=\pi$) 
...
\begin{array}{|c|c|c|c|c|}
\hline
n\backslash q & 1 & 3 & 5 & 7\\
\hline
&&&&\\[-2ex]
0 & -3\bar{C} & 2\bar{C} & -\frac{23\bar{C}}{20} & \frac{557\bar{C}}{840}
\\[1ex]
1 & -\frac{39\bar{C}}{5} & \frac{62\bar{C}}{5} & -\frac{1469\bar{C}}{100} & \frac{61547\bar{C}}{4200}
\\[1ex]
2 & -\frac{2241\bar{C}}{175} & \frac{936\bar{C}}{25} & -\frac{65034\bar{C}}{875} & \frac{1391541\bar{C}}{12250}
\\[1ex]
3 & -\frac{621\bar{C}}{35} & \frac{14544\bar{C}}{175} & -\frac{8658\bar{C}}{35} & \frac{3276876\bar{C}}{6125}
\\[1ex]
4 & -\frac{1527633\bar{C}}{67375} & \frac{2095488\bar{C}}{13475} & -\frac{217646712\bar{C}}{336875} & \frac{882964668\bar{C}}{471625}
\\[1ex]
5 & -\frac{604542933\bar{C}}{21896875} & \frac{519037632\bar{C}}{1990625} & -\frac{157533957432\bar{C}}{109484375} 
  & \frac{4115715199668\bar{C}}{766390625}
\\[1ex]
6 & -\frac{3563022249\bar{C}}{109484375} & \frac{44328943872\bar{C}}{109484375} & -\frac{1566522576576\bar{C}}{547421875} 
  & \frac{51162484117968\bar{C}}{3831953125}
\\[1ex]
\hline
\end{array}
\]
\caption{The coefficients of the partial sums $\sum_{p=0}^{n}\gamma^p\grave{\kappa}^q$ in the 
asymptotic expansion of $\Im\bar{\lambda}$ about $\grave{\kappa}=0$ (or $\kappa=\pi$) 
for leading values of $n$ and $q$, up to ${\cal O}(\gamma^{n+1},\bar{C}^3)$.}
