...
In order to invesigate the stability of these higher-order approximations, we instead utilise the
McLaurin series expansion of $S$ in terms of $\kappa$, namely
\begin{eqnarray}
S\tilde{u} & \sim & \tilde{u}\left(1+\frac{1}{6}\kappa^2+\frac{1}{72}\kappa^4
+\frac{1}{2160}\kappa^6-\frac{17}{362880}\kappa^8+\cdots\right)\,,
\end{eqnarray}
and consider the partial sums $\sum_{p=0}^{n}\gamma^p\kappa^q$ of terms in the real part of the
subsequent expansion for $\dot{\tilde{u}}$.
...
asymptotic expansion of $\Re\bar{\lambda}$ for leading values of $n$ and $q$.}
