...
\end{eqnarray}
This condition implies, for example, that at second order
\begin{eqnarray}
   [\hat{u}'_2]_j = \frac{1}{H}\left.\delta^{2}\hat{u}_2\right|_{X_j}
...
\gaj{What does this say about our overall stability?}
...
with the residual 
\begin{eqnarray}
R &= & \sum_{j=\underline{J}+1}^{\bar{J}}\left[u'v-v'u\right]_{X_{j-1}}^{X_j}\,,
\end{eqnarray}
...
\end{eqnarray}
where, assuming that $v$ also obeys conditions~(\ref{eq:cont-cond}) and~(\ref{eq:smooth-cond}),
\begin{eqnarray}
...
\gaj{Counter example?: 2 intervals $\Rightarrow [r]_1 = (U_0+U_2)V_1-(V_0+V_2)U_1$.
Assume material conservation at boundaries, i.e. u'=v'=0.
Then $R=-[r]_1\neq 0$.}
\gaj{Try $[u']_0=0 \Rightarrow U_{-1}=2U_0-U_1$, $[u']_2=0 \Rightarrow U_3=2U_2-U_1$. So $R=-[r]_0-[r]_1-[r]_2
=-U_{-1}V_0+V_{-1}U_0
-U_3V_2+V_3U_2
=U_1V_0-V_1U_0
+U_1V_2-V_1U_2
