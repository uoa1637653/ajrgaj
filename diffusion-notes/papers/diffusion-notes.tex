...
for leading values of $n$ and $q$. The special case of $q=0$ gives the stability of the sawtooth mode.}
...
\hline
&&&\\[-2ex]
$\bar{\lambda}$ & $-\frac{11\bar{C}^2+60}{5}$ & $-\frac{604\bar{C}^2+1680}{175}$
 & $-\frac{820\bar{C}^2+1728}{175}$
\\[1ex]\hline
%&&&&\\[-2ex]
$n$ & 4 & 5 & 6\\
\hline
&&&\\[-2ex]
$\bar{\lambda}$  & $-\frac{398752\bar{C}^2+665280}{67375}$
 & $-\frac{156609952\bar{C}^2+216103680}{21896875}$ 
 & $-\frac{918126656\bar{C}^2+1080552960}{109484375}$\\[1ex]
\hline
\end{tabular}
\caption{Stability of the sawtooth mode for ${\cal O}(\gamma^{n+1},\bar{C}^3)$ truncations of $\hat{g}_j$,
