...
Now, recall from Section~\ref{sec:centre-man} that the eigensolution~\eqref{eq:raw-eigmode} 
to the diffusion equation~\eqref{eq:diff} has the spectrum $\lambda=-k^2$.
...
\end{eqnarray}
which reveals an error of size ${\cal O}(H^2k^4)$ in comparison to the true spectrum.
